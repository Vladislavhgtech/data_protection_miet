# матрица подстановки на основе числа Пи
s = [
      [
...
def driver(encrypt_data):

#•	Выделяем массив из 18 элементов для раундовых ключей сети Фейстеля и 
# матрицы подстановки.
...
# Шифруем раундовые ключи и матрицы подстановки с помощью сети Фейстеля.
